...
for node_name in ${!MASTER_NODES[@]}; do
    echo ">>> $node_name ${MASTER_NODES[$node_name]}"
    sed -e "s/##NODE_NAME##/$node_name/" -e "s/##NODE_IP##/${MASTER_NODES[$node_name]}/" etcd.service.template > etcd-${MASTER_NODES[$node_name]}.service 
  done
ls *.service
```
...
``` bash
>>> 10.1.80.72
https://10.1.80.72:2379 is healthy: successfully committed proposal: took = 2.400146ms
>>> 10.1.80.73
https://10.1.80.73:2379 is healthy: successfully committed proposal: took = 1.702173ms
>>> 10.1.80.71
https://10.1.80.71:2379 is healthy: successfully committed proposal: took = 1.733435ms
```
...
+-------------------------+------------------+---------+---------+-----------+-----------+------------+
| https://10.1.80.71:2379 | 5c89316247d9a7e3 |  3.3.13 |   20 kB |     false |         2 |          8 |
| https://10.1.80.72:2379 | 49707345a7e62a08 |  3.3.13 |   20 kB |     false |         2 |          8 |
| https://10.1.80.73:2379 | 8223a6575b179201 |  3.3.13 |   20 kB |      true |         2 |          8 |
+-------------------------+------------------+---------+---------+-----------+-----------+------------+
```
+ 可见，当前的 leader 为 10.1.80.73。