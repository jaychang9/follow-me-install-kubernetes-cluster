...
MASTER_NODES=(['k8s-m1']="192.168.56.101" ['k8s-m2']="192.168.56.102" ['k8s-m3']="192.168.56.103")
WORKER_NODES=(['k8s-n1']="192.168.56.104")
...
# etcd 集群间通信的 IP 和端口
export ETCD_NODES="k8s-m1=https://192.168.56.101:2380,k8s-m2=https://192.168.56.102:2380,k8s-m3=https://192.168.56.103:2380"

# kube-apiserver 的 VIP（HA 组件 keepalived 发布的 IP）
export MASTER_VIP=192.168.56.100
