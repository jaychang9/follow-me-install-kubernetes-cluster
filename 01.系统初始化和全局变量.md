...
for node_name in ${!ALL_NODES[@]}; do
 ...
 sed -i 's#http://us.archive.ubuntu.com#https://mirrirs.aliyun.com#g' /etc/apt/sources.list
 sed -i 's#http://security.ubuntu.com#https://mirrirs.aliyun.com#g' /etc/apt/sources.list
 apt update -y
done
```
